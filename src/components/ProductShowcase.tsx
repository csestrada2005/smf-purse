          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
            ...
            >
              <Link to="/product" className="block">
                <div className="aspect-[3/4] flex items-center justify-center overflow-hidden mb-6">
                  <motion.img 
                    src={indianHeritage}
                ...
                <div className="text-center">
                  <h3 className="text-noir text-sm uppercase tracking-[0.2em] mb-1 font-semibold">
                    The Indian Heritage
                  </h3>
                  <p className="text-gold text-xs uppercase tracking-widest hover:text-noir transition-colors duration-500">
                    Explore
                  </p>
                </div>
              </Link>
