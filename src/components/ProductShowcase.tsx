...
const ProductShowcase = () => {
  return (
    <FullPageSection className="bg-white">
      <div className="flex-1 flex flex-col items-center justify-start px-4 sm:px-12 lg:px-20 pt-12 sm:pt-16 pb-4 sm:py-8 h-full">
        <div className="max-w-6xl mx-auto w-full h-full flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-6 lg:gap-12 flex-1">
            ...
            <motion.div 
              ...
              viewport={{ once: false }}
            >
              <Link to="/collection" className="flex flex-col h-full items-center">
                <div className="flex-1 flex items-start justify-center overflow-hidden">
                  <motion.img 
                    src={indianHeritage}
                    alt="The Indian Heritage - Woman with purse silhouette" 
                    className="max-h-full w-auto object-contain"
                    style={{ maxHeight: 'min(45vh, 350px)' }}
                ...
                <div className="text-center py-0 sm:py-4">
