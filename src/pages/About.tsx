...
const values = [
  ...
  },
  {
    ...
    description: "Proudly designed and crafted in Mexico, celebrating the rich heritage of Mexican craftsmanship with a modern vision."
  }
];
...
const About = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Values Section */}
      <section className="py-16 px-6 sm:px-12 bg-section-2">
        <div className="max-w-6xl mx-auto">
          <motion.div
