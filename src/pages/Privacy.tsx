        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <section>
              ...
              <p>Clasp ("we," "our," or "us") respects your privacy and is committed to protecting your personal data. This privacy policy explains how we collect, use, disclose, and safeguard your information when you visit our website or make a purchase.</p>
            </section>
            <section>
            ...
            <section>
              ...
              <div className="mt-4 p-6 bg-section-2 border border-accent/20 rounded">
                <p><strong className="text-foreground">Clasp</strong></p>
                <p className="text-accent">Email: privacy@clasp.com</p>
