              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      required
                      className="bg-section-2 border-gold/20 focus:border-gold text-foreground placeholder:text-cream/40"
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={handleChange}
                    required
                    className="bg-section-2 border-gold/20 focus:border-gold min-h-[150px] text-foreground placeholder:text-cream/40"
                ...
                <Button 
                  ...
                  className="w-full bg-gold text-noir hover:bg-gold-light font-medium"
                >
